...
#define STRING_CONFIG_H_AUTHOR "(1138-4EB, Eljeko i3 v1.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mi3x v1.6"
 ...
 * M92 X80.60 Y80.50 Z400.00 E102.00
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.60, 80.50, 400, 1605.37 }
